...
description: |
  ...
  The project consisted of three residency phases across Europe, each culminating in a public performance: Florence (Fabbrica Europa Festival, May 2012), Budapest (Sziget Festival A38 stage, August 2012), and Bucharest (Godot Café, October 2012). A pre-show was also organized at Toldi Club, Budapest in July 2012.
...
sections:
  ...
  - type: text
    content: |
      Talking heArts brought together 17 young artists from four European countries in three successive residencies across the continent. Each residency phase led to a public performance, progressively building the show's complexity and cast.

      **Florence — May 2012**
      First residency at Sonoria youth and music centre and BiblioteCaNova, Florence. Preview performance at Le Murate Caffe Letterario during the 19th edition of Fabbrica Europa Festival (May 5, 2012).

      **Budapest — July–August 2012**
      Pre-show at Toldi Club (July 2012) with local guest artists, followed by the main residency and a 40-minute performance on the A38 stage at Sziget Festival (August 7, 2012, 23:15). Guest performers included Bari Kim (contemporary dance, Germany), Gregory Zeigler (percussion, USA), Zoltán Grecsó (dance, Budapest), and Krisztina Bogó (visual art, Budapest).
