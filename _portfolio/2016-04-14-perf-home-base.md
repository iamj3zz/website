...
abstract: 'Space, sound, and dance installation featuring composer/music producer
  ...
  '
description: Space, sound, and dance installation featuring composer/music producer
  J3ZZ's commissioned soundtrack.
...
metadata:
  ...
  collaborators: Nóemi Kulcsár (choreography, direction), Rubi Anna (concept, co-direction),
    J3ZZ (composer, music producer), Cseh Dávid (dramaturge), Csere Zoltán (lighting
    design)
  credits: 'Choreography & Direction: Nóemi Kulcsár. Concept & Co-direction: Rubi
    Anna. Music & Sound Design: J3ZZ. Dramaturge: Cseh Dávid. Lighting & Assistant:
    Csere Zoltán'
  custom:
  - label: Venue
