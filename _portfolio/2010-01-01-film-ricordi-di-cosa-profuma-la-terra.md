...
abstract: 'An experimental animated short film. The composer created an entirely original
  ...
  '
description: An experimental animated short film. The composer created an entirely
  original soundscape using home-recorded audio samples, guitar, and violin — building
  a complete sonic landscape from intimate domestic sources.
category: films
commissioned: false
image: "/assets/works/2010-01-01-film-ricordi-di-cosa-profuma-la-terra/thumbnail.jpg"
metadata:
  release_date: '2010-01-01'
  location: Florence, Italy
  role: composer, performer, sound designer
  collaborators: Olga Pavlenko (animation director)
  credits: 'Animation Direction: Olga Pavlenko. Composition/Performance/Sound Design:
    J3ZZ'
  custom:
  - label: Animator/Director
    value: Olga Pavlenko
    link: https://www.imdb.com/name/nm2985258/
  - label: Methodology
    value: Site-specific sound design using home-recorded audio samples, guitar, and
      violin
  - label: Festival
    value: ZOOM Festival 2011, Scandicci
...
- type: description
- type: text
  title: Animated Narrative, Domestic Sound
  content: |
