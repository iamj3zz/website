...
abstract: 'A sophisticated experimental project exploring live improvisation with
  ...
  '
description: A sophisticated experimental project exploring live improvisation with
  acoustic strings and electronics, blending disruption with harmony, and contemporary
  experimental aesthetics with acoustic classical roots.
category: live-acts
commissioned: false
image: "/assets/works/2011-09-29-live-hybris/thumbnail.jpg"
metadata:
  date: 2011–2017
  location: Budapest, Hungary
  event_name: HYBRIS ongoing project
  based_in: Budapest, Hungary
  role: violinist, co-founder
  collaborators: Endre Kertesz (cello), musicians from Hungary and Europe (computer
    programming, electronics), visual artist from Belgium
  custom:
  - label: Hybris Ex Nihilo (Live)
    value: Album release
