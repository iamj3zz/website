...
metadata:
  ...
  custom:
    ...
    - label: "Key Concept"
      value: "Biosonification — transforming plant bio-signals into sound and visuals"
    - label: "Subtitle"
...
sections:
  ...
  - type: text
    content: |
      ...
      **Racines & Résonances** has been presented at notable events since its first performance in 2020:
      ...
      * **October 18, 2020: Széllkapu, Millenáris, Budapest (Hungary)** — First public performance.
