...
abstract: 'Cross-cultural jam session with Tuareg ensemble TADALAT, exploring desert
  ...
  '
description: Cross-cultural jam session with Tuareg ensemble TADALAT, exploring desert
  blues and Saharan musical traditions.
category: live-acts
commissioned: false
...
metadata:
  ...
  role: violinist
  collaborators: Oumar Ould Badi (guitar/vocals), Aboubacrene Ag Mohamed (guitar/vocals),
    Zeidi Ag Baba (bass/choir), Mohamed Ag Ibrahim (djembe), Issa Samaké (calebasse),
...
- type: hero-image
  ...
  caption: TADALAT — Festival au Désert/presenze d'Africa, Complesso delle Murate,
    Florence, July 2013
- type: text
