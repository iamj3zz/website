...
abstract: 'A four-minute science fiction short created in 48 hours for SCI-FI-LONDON
  ...
  claim over biological life.

  '
description: A four-minute science fiction short created in 48 hours for SCI-FI-LONDON
  2012. A speculative fiction exploring population control, mortality, and the state's
  claim over biological life.
category: films
commissioned: false
...
metadata:
  ...
  collaborators: Lorenzo Ciacciavicca (director, filmmaker)
  credits: 'Director/Filmmaker: Lorenzo Ciacciavicca. Composer/Performer/Producer:
    J3ZZ'
  custom:
  - label: Duration
    value: 4 minutes 11 seconds
  - label: Format
    value: Science fiction short film
  - label: Festival
    value: SCI-FI-LONDON 48 Hour Film Challenge 2012
    link: https://48hour.sci-fi-london.com/
  - label: YouTube
    value: youtu.be/zonTHRlU5OI
    link: https://youtu.be/zonTHRlU5OI
  - label: Director
    value: Lorenzo Ciacciavicca
    link: https://www.rootsnroutes.eu/rnrstories-id101
sections:
- type: iframe
  embed_code: <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/zonTHRlU5OI"
    frameborder="0" allowfullscreen></iframe>
  responsive: true
  aspect_ratio: '16:9'
  caption: FAR POINT — SCI-FI-LONDON 48 Hour Film Challenge 2012
- type: description
- type: text
  title: Speculative Fiction Under Constraint
  content: |
...
- type: text
  title: Sound Design in Science Fiction
  content: |
