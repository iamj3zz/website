...
abstract: 'An experimental dance short film created during a creative residency in
  ...
  and production by J3ZZ.

  '
description: An experimental dance short film created during a creative residency
  in Cologne. Co-directed by Ana Maria Staicu and Paris Tume, with original music
  composition and production by J3ZZ.
category: films
commissioned: false
...
metadata:
  ...
  collaborators: Ana Maria Staicu (co-director), Paris Tume (co-director), Deborah
    Sophia Leist (performer), Myriam Meret (title design)
  credits: 'Co-directors: Ana Maria Staicu, Paris Tume. Composer/Producer: J3ZZ. Performer:
    Deborah Sophia Leist. Title Design: Myriam Meret'
  custom:
  - label: Residency/Network
    value: ROOTS & ROUTES International Association
    link: https://www.rootsnroutes.eu/
  - label: Project
    value: ROOTS & ROUTES video archive
    link: http://rootsnroutes.eu/video-id1410
  - label: Format
    value: Experimental dance short film
...
- type: description
- type: text
  title: Dance as Visual Language
  content: |
