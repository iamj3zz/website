...
abstract: 'Solo violin improvisation show — nude and contemporary acoustic violin,
  ...
  '
description: Solo violin improvisation show — nude and contemporary acoustic violin,
  performed live without preparation. Two recordings released on Bandcamp.
category: live-acts
commissioned: false
image: "/assets/works/2013-09-12-live-sur-le-fil/thumbnail.jpg"
metadata:
  date: 2013–2017
  ...
  custom:
  - label: Format
    value: Solo acoustic violin improvisation — no preparation, no electronics
  - label: Bandcamp — Frau Frisor recording
    value: SUR LE FIL (Live at Frau Frisor 12/09/2013) — 25:42
    link: https://music.jeromelithiaote.com/album/sur-le-fil-live-at-frau-frisor-12-09-2013
  - label: Bandcamp — FKSE recording
    value: SUR LE FIL (Live at FKSE 02/07/2015) — 15:09
    link: https://music.jeromelithiaote.com/track/sur-le-fil-live-at-fkse-02-07-2015
  - label: FKSE credits
    value: 'Audio: Zsolt László Kiss · Video: Erlich Gábor · Mix: J3ZZ · Curated by
      Erlich Gábor & Tábori András'
sections:
- type: description
- type: text
  title: 'A solo inquiry: The violin in its nakedness'
  content: |
...
- type: text
  title: A journey through the violin's many faces
  content: |
...
- type: text
  title: The irreplaceability of the live moment
  content: |
...
- type: text
  title: 'The solemnity of the instant: A musical ceremony'
  content: |
    ...
    **An act of moral commitment**
    ...
    The solemnity of Sur le fil also comes from the fact that the musician stakes their reputation, their integrity with every instant. There is no safety net. If the performance fails, it fails publicly, irreversibly. These high stakes create genuine moral tension, authentic gravity.

    In contrast with much contemporary music that relies on technical complexity or formal innovation, Sur le fil rests on something more primordial: sincerity, authenticity of the act of playing. It is an act of offering, where the musician exposes themself without protection, inviting the audience to witness this moment. This accepted vulnerability creates a solemn atmosphere that transcends the music itself — it becomes a fundamental human gesture.
