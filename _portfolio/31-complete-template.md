...
1. Copy this file to a new filename: ##-your-work-name.md
2. Update the basic front matter (title, work_id, abstract, category, image, order)
3. Remove metadata fields that don't apply to your work category
4. Keep only the section modules you need (remove others)
5. Update content, images, and captions
6. Test locally: bundle exec jekyll serve

METADATA GUIDELINES BY CATEGORY:

INSTALLATIONS:
- Keep: year, date, location, places, role, technology, collaborators,
...
COLLABORATIONS:
- Keep: year, location, role, technology, collaborators, credits,
