...
metadata:
  ...
  credits: 'Sound artist & performer: J3ZZ. Trapeze artist: Audrey Louwet (Compagnie
    Azeïn). Programme: Park in Progress 11th edition, Pépinières Européennes pour
    Jeunes Artistes. Host: ARTos Foundation.'
  custom:
  - label: Programme
  ...
  - label: Press
    value: AVANT-GARDE (Cyprus contemporary art magazine) — Park in Progress 11 /
      J3ZZ
  ...
  - label: ''
    value: Transcultures — Park in Progress 11, Nuit Européenne de la Jeune Création,
      Chypre (FR)
  ...
  - label: ''
    value: 'PDF: Transcultures — Park in Progress 11, Nuit Européenne de la Jeune
      Création (archive)'
...
- type: iframe
  ...
  responsive: true
  aspect_ratio: '16:9'
  caption: Park in Progress 11 — Municipal Gardens, Nicosia, Cyprus, September–October
    2014
- type: description
- type: hero-image
