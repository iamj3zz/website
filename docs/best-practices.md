...
- ✅ Add `abstract` field for grid hover and printable page display (1-2 sentences, 150-200 characters)
- ✅ Add `description` field for work detail page (required, 3-5 sentences, 200-400 characters)
