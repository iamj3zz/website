...
<section id="works">
  ...
  <div class="portfolio-grid">
    {% assign sorted_portfolio = site.portfolio | where_exp: "w", "w.lang == 'fr'" | sort: 'metadata.release_date' | reverse %}
  ...
  <div class="works-list-print">
    ...
    {% assign all_works = site.portfolio | where_exp: "w", "w.lang == 'fr'" | sort: 'metadata.release_date' | reverse %}
